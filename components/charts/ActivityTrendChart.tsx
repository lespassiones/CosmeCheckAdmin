...
/**
 * Same visual language as DailyTrendChart, but for the activity-page data
 * shape (analyses + ocr per day). Kept as a sibling component rather than
 * widening the original union so the gold-standard chart stays untouched.
 */
    ...
    <div className="h-[200px] w-full">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id={`grad-activity-${series}`} x1="0" y1="0" x2="0" y2="1">
